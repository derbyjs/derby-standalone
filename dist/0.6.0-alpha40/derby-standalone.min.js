...
function inputSupportsSelection(e){var t=e.type;return"text"===t||"search"===t||"url"===t||"tel"===t||"password"===t}function inputIsNumberValue(e){var t=e.type;return"number"===t||"range"===t&&!e.multiple}function inputValue(e){return inputIsNumberValue(e)?e.valueAsNumber:e.value}function addDocumentListeners(e){e.addEventListener("input",documentInput,!0),e.addEventListener("change",documentChange,!0),parseFloat(window.navigator.appVersion.split("MSIE ")[1])<=9&&e.addEventListener("selectionchange",function(){document.activeElement&&documentInput({target:document.activeElement})},!0);var t=document.createElement("input");t.type="number",t.value="7",t.valueAsNumber!==t.valueAsNumber&&(oldInputValue=inputValue,inputValue=function(e){return"number"===e.type?inputIsNumberValue(e)?parseFloat(e.value):e.value:oldInputValue.apply(this,arguments)})}function documentInput(e){var t=e.target;if("INPUT"===t.tagName){var n=t.$bindAttributes&&t.$bindAttributes.value;if(!n||n.isUnbound())return;if(inputSupportsSelection(t)){var i={$event:e};textDiffBinding(n,t.value,i)}else{var u=inputValue(t);n.template.expression.set(n.context,u)}}else if("TEXTAREA"===t.tagName&&1===t.childNodes.length){var n=t.firstChild&&t.firstChild.$bindNode;if(!n||n.isUnbound())return;var i={$event:e};textDiffBinding(n,t.value,i)}}function applyAttributeBinding(e,t,n){var i=e.$bindAttributes&&e.$bindAttributes[t];if(i&&!i.isUnbound()){var u=n?n(e):e[t];i.template.expression.set(i.context,u)}}function documentChange(e){var t=e.target;"INPUT"===t.tagName?(applyAttributeBinding(t,"checked"),applyAttributeBinding(t,"value",inputValue)):"SELECT"===t.tagName&&setOptionBindings(t)}function textDiffBinding(e,t,n){var i=e.template.expression,u=i.pathSegments(e.context);if(u){var a=e.context.controller.model.pass(n);textDiff.onTextInput(a,u,t)}else i.set&&i.set(e.context,t)}function setOptionBindings(e){for(var t=e.firstChild;t;t=t.nextSibling)if("OPTION"===t.tagName){var n=t.$bindAttributes&&t.$bindAttributes.selected;if(!n||n.isUnbound())continue;n.template.expression.set(n.context,t.selected)}else t.hasChildNodes()&&setOptionBindings(t)}var textDiff=require("./textDiff");exports.add=addDocumentListeners,exports.inputSupportsSelection=inputSupportsSelection;
