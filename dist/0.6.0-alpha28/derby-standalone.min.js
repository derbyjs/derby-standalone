...
function Page(e,t,n,s){Controller.call(this,e,this,t),this.req=n,this.res=s,this.params=null,this.init&&this.init(t),this.context=this._createContext(),this._eventModel=null,this._removeModelListeners=null,this._components={},this._addListeners()}function addDependencies(e,t,n){var s=t.dependencies(n.context);if(s)for(var i=0,o=s.length;o>i;i++){var r=s[i];r&&e.addBinding(r,n)}}function patchTextBinding(e){e instanceof templates.AttributeBinding&&"value"===e.name&&"INPUT"===e.element.tagName&&documentListeners.inputSupportsSelection(e.element)&&e.template.expression.resolve(e.context)?e.update=textInputUpdate:e instanceof templates.NodeBinding&&"TEXTAREA"===e.node.parentNode.tagName&&e.template.expression.resolve(e.context)&&(e.update=textAreaUpdate)}function textInputUpdate(e){textUpdate(this,this.element,e)}function textAreaUpdate(e){var t=this.node.parentNode;t&&textUpdate(this,t,e)}function textUpdate(e,t,n){if(n){if(n.$event&&n.$event.target===t)return;if(n.$stringInsert)return textDiff.onStringInsert(t,n.$previous,n.$stringInsert.index,n.$stringInsert.text);if(n.$stringRemove)return textDiff.onStringRemove(t,n.$previous,n.$stringRemove.index,n.$stringRemove.howMany)}if("TEXTAREA"===t.tagName){var s=e.template,i=s.expression.get(e.context);return t.value=s.stringify(i)}e.template.update(e.context,e)}var derbyTemplates=require("derby-templates"),contexts=derbyTemplates.contexts,expressions=derbyTemplates.expressions,templates=derbyTemplates.templates,util=require("racer/lib/util"),EventModel=require("./eventmodel"),textDiff=require("./textDiff"),Controller=require("./Controller"),documentListeners=require("./documentListeners");module.exports=Page,util.mergeInto(Page.prototype,Controller.prototype),Page.prototype.$bodyClass=function(e){if(e){for(var t=[],n=e.split(":"),s=0,i=n.length;i>s;s++){var o=n.slice(0,s+1).join("-");t.push(o)}return t.join(" ")}},Page.prototype.$preventDefault=function(e){e.preventDefault()},Page.prototype.$stopPropagation=function(e){e.stopPropagation()},Page.prototype._setRenderParams=function(e){this.model.set("$render.ns",e),this.model.set("$render.params",this.params),this.model.set("$render.url",this.params&&this.params.url),this.model.set("$render.query",this.params&&this.params.query)},Page.prototype._setRenderPrefix=function(e){var t=e?e+":":"";this.model.set("$render.prefix",t)},Page.prototype.get=function(e,t,n){this._setRenderPrefix(t);var s=this.getView(e,t);return s.get(this.context,n)},Page.prototype.getFragment=function(e,t){this._setRenderPrefix(t);var n=this.getView(e,t);return n.getFragment(this.context)},Page.prototype.getView=function(e,t){return this.app.views.find(e,t)},Page.prototype.render=function(e){this.app.emit("render",this),this.context.pause(),this._setRenderParams(e);var t=this.getFragment("TitleElement",e),n=this.getFragment("BodyElement",e),s=document.getElementsByTagName("title")[0];s.parentNode.replaceChild(t,s),document.body.parentNode.replaceChild(n,document.body),this.context.unpause(),this.app.emit("routeDone",this,"render")},Page.prototype.attach=function(){this.context.pause();var e=this.model.get("$render.ns"),t=this.getView("TitleElement",e),n=this.getView("BodyElement",e),s=document.getElementsByTagName("title")[0];t.attachTo(s.parentNode,s,this.context),n.attachTo(document.body.parentNode,document.body,this.context),this.create&&this.create(this.model,this.dom),this.context.unpause()},Page.prototype._createContext=function(){var e=new contexts.ContextMeta;e.views=this.app&&this.app.views;var t=new contexts.Context(e,this);return t.expression=new expressions.PathExpression([]),t.alias="#root",t},Page.prototype._addListeners=function(){var e=this._eventModel=new EventModel;this._addModelListeners(e),this._addContextListeners(e)},Page.prototype.destroy=function(){this.emit("destroy"),this._removeModelListeners();for(var e in this._components){var t=this._components[e];t.destroy()}var n=this.model.silent();n.destroy("_page"),n.destroy("$components"),n.unloadAll&&n.unloadAll()},Page.prototype._addModelListeners=function(e){var t=this.model;if(t){var n=this.context,s=t.on("change","**",function(t,s,i,o){var r=util.castSegments(t.split("."));n.pause(),o.$previous=i,e.set(r,o),n.unpause()}),i=t.on("load","**",function(t){var s=util.castSegments(t.split("."));n.pause(),e.set(s),n.unpause()}),o=t.on("unload","**",function(t){var s=util.castSegments(t.split("."));n.pause(),e.set(s),n.unpause()}),r=t.on("insert","**",function(s,i,o){var r=util.castSegments(s.split("."));n.pause();var a=t.get(s);o.length<a.length?e.insert(r,i,o.length):e.set(r),n.unpause()}),a=t.on("remove","**",function(s,i,o){var r=util.castSegments(s.split("."));n.pause();var a=t.get(s);a&&a.length?e.remove(r,i,o.length):e.set(r),n.unpause()}),p=t.on("move","**",function(t,s,i,o){var r=util.castSegments(t.split("."));n.pause(),e.move(r,s,i,o),n.unpause()});this._removeModelListeners=function(){t.removeListener("change",s),t.removeListener("load",i),t.removeListener("unload",o),t.removeListener("insert",r),t.removeListener("remove",a),t.removeListener("move",p)}}},Page.prototype._addContextListeners=function(e){function t(t){var n=t.expression.resolve(t);e.addItemContext(n,t)}function n(){}function s(t){patchTextBinding(t);var n=t.template.expressions;if(n)for(var s=0,i=n.length;i>s;s++)addDependencies(e,n[s],t);else{var o=t.template.expression,r=o.meta&&o.meta.blockType;if("with"===r)return;addDependencies(e,o,t)}}function i(t){e.removeBinding(t)}function o(e){var t=e.$markComponent;t&&!t.singleton&&t.destroy()}this.context.meta.addBinding=s,this.context.meta.removeBinding=i,this.context.meta.removeNode=o,this.context.meta.addItemContext=t,this.context.meta.removeItemContext=n},util.serverRequire(module,"./Page.server");
