...
(function (global){
function Page(e,t,n,o){Controller.call(this,e,this,t),this.req=n,this.res=o,this.params=null,this.init&&this.init(t),this.context=this._createContext(),this._eventModel=null,this._removeModelListeners=null,this._components={},this._addListeners()}function addDependencies(e,t,n){var o=t.dependencies(n.context);if(o)for(var s=0,i=o.length;i>s;s++){var r=o[s];r&&e.addBinding(r,n)}}function patchTextBinding(e){e instanceof templates.AttributeBinding&&"value"===e.name&&"INPUT"===e.element.tagName&&documentListeners.inputSupportsSelection(e.element)&&e.template.expression.resolve(e.context)?e.update=textInputUpdate:e instanceof templates.NodeBinding&&"TEXTAREA"===e.node.parentNode.tagName&&e.template.expression.resolve(e.context)&&(e.update=textAreaUpdate)}function textInputUpdate(e){textUpdate(this,this.element,e)}function textAreaUpdate(e){var t=this.node.parentNode;t&&textUpdate(this,t,e)}function textUpdate(e,t,n){if(n){if(n.$event&&n.$event.target===t)return;if("stringInsert"===n.$type)return textDiff.onStringInsert(t,n.previous,n.index,n.text);if("stringRemove"===n.$type)return textDiff.onStringRemove(t,n.previous,n.index,n.howMany)}if("TEXTAREA"===t.tagName){var o=e.template,s=o.expression.get(e.context);return t.value=o.stringify(s)}e.template.update(e.context,e)}var derbyTemplates=require("derby-templates"),contexts=derbyTemplates.contexts,expressions=derbyTemplates.expressions,templates=derbyTemplates.templates,util=require("racer/lib/util"),EventModel=require("./eventmodel"),textDiff=require("./textDiff"),Controller=require("./Controller"),documentListeners=require("./documentListeners");module.exports=Page,Page.prototype=Object.create(global,{parent:{value:null}}),util.mergeInto(Page.prototype,Controller.prototype),Page.prototype.$bodyClass=function(e){if(e){for(var t=[],n=e.split(":"),o=0,s=n.length;s>o;o++){var i=n.slice(0,o+1).join("-");t.push(i)}return t.join(" ")}},Page.prototype.$preventDefault=function(e){e.preventDefault()},Page.prototype.$stopPropagation=function(e){e.stopPropagation()},Page.prototype._setRenderParams=function(e){this.model.set("$render.ns",e),this.model.set("$render.params",this.params),this.model.set("$render.url",this.params&&this.params.url),this.model.set("$render.query",this.params&&this.params.query)},Page.prototype._setRenderPrefix=function(e){var t=e?e+":":"";this.model.set("$render.prefix",t)},Page.prototype.get=function(e,t,n){this._setRenderPrefix(t);var o=this.getView(e,t);return o.get(this.context,n)},Page.prototype.getFragment=function(e,t){this._setRenderPrefix(t);var n=this.getView(e,t);return n.getFragment(this.context)},Page.prototype.getView=function(e,t){return this.app.views.find(e,t)},Page.prototype.render=function(e){this.app.emit("render",this),this.context.pause(),this._setRenderParams(e);var t=this.getFragment("TitleElement",e),n=this.getFragment("BodyElement",e),o=document.getElementsByTagName("title")[0];o.parentNode.replaceChild(t,o),document.body.parentNode.replaceChild(n,document.body),this.context.unpause(),this.app.emit("routeDone",this,"render")},Page.prototype.attach=function(){this.context.pause();var e=this.model.get("$render.ns"),t=this.getView("TitleElement",e),n=this.getView("BodyElement",e),o=document.getElementsByTagName("title")[0];t.attachTo(o.parentNode,o,this.context),n.attachTo(document.body.parentNode,document.body,this.context),this.create&&this.create(this.model,this.dom),this.context.unpause()},Page.prototype._createContext=function(){var e=new contexts.ContextMeta;e.views=this.app&&this.app.views;var t=new contexts.Context(e,this);return t.expression=new expressions.PathExpression([]),t.alias="#root",t},Page.prototype._addListeners=function(){var e=this._eventModel=new EventModel;this._addModelListeners(e),this._addContextListeners(e)},Page.prototype.destroy=function(){this.emit("destroy"),this._removeModelListeners();for(var e in this._components){var t=this._components[e];t.destroy()}var n=this.model.silent();n.destroy("_page"),n.destroy("$components"),n.unloadAll&&n.unloadAll()},Page.prototype._addModelListeners=function(e){var t=this.model;if(t){var n=this.context,o=t.on("change","**",function(t,o,s,i){var r=util.castSegments(t.split("."));n.pause(),i.previous=s,e.set(r,i),n.unpause()}),s=t.on("load","**",function(t){var o=util.castSegments(t.split("."));n.pause(),e.set(o),n.unpause()}),i=t.on("unload","**",function(t){var o=util.castSegments(t.split("."));n.pause(),e.set(o),n.unpause()}),r=t.on("insert","**",function(o,s,i){var r=util.castSegments(o.split("."));n.pause();var a=t.get(o);i.length<a.length?e.insert(r,s,i.length):e.set(r),n.unpause()}),a=t.on("remove","**",function(o,s,i){var r=util.castSegments(o.split("."));n.pause();var a=t.get(o);a&&a.length?e.remove(r,s,i.length):e.set(r),n.unpause()}),p=t.on("move","**",function(t,o,s,i){var r=util.castSegments(t.split("."));n.pause(),e.move(r,o,s,i),n.unpause()});this._removeModelListeners=function(){t.removeListener("change",o),t.removeListener("load",s),t.removeListener("unload",i),t.removeListener("insert",r),t.removeListener("remove",a),t.removeListener("move",p)}}},Page.prototype._addContextListeners=function(e){function t(t){var n=t.expression.resolve(t);e.addItemContext(n,t)}function n(){}function o(t){patchTextBinding(t);var n=t.template.expressions;if(n)for(var o=0,s=n.length;s>o;o++)addDependencies(e,n[o],t);else{var i=t.template.expression,r=i.meta&&i.meta.blockType;if("with"===r)return;addDependencies(e,i,t)}}function s(t){e.removeBinding(t)}function i(e){var t=e.$markComponent;t&&!t.singleton&&t.destroy()}this.context.meta.addBinding=o,this.context.meta.removeBinding=s,this.context.meta.removeNode=i,this.context.meta.addItemContext=t,this.context.meta.removeItemContext=n},util.serverRequire(module,"./Page.server");
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
function addIndexListeners(e){function t(t,r){var n=e._refs.fromMap;for(var o in n){var s=n[o];if(s.updateIndices&&util.contains(t,s.toSegments)&&s.toSegments.length>t.length){var i=+s.toSegments[t.length],a=r(i);i!==a&&(e._refs.remove(o),s.toSegments[t.length]=""+a,s.to=s.toSegments.join("."),e._refs._add(s))}}}e.on("insert",function(e,r){function n(e){return e>=o?e+s:e}var o=r[0],s=r[1].length;t(e,n)}),e.on("remove",function(e,r){function n(e){return e>=o?e-s:e}var o=r[0],s=r[1].length;t(e,n)}),e.on("move",function(e,r){function n(e){return e>=o&&o+i>e?e+s-o:(e>=o&&(e-=i),e>=s&&(e+=i),e)}var o=r[0],s=r[1],i=r[2];t(e,n)})}function refChange(e,t,r,n){var o=r[0];if(void 0===o){var s=n.slice(),i=s.pop(),a=e._get(s);if(!(a&&i in a))return void e._del(t)}e._set(t,o)}function refLoad(e,t,r){var n=r[0];e._set(t,n)}function refUnload(e,t){e._del(t)}function refInsert(e,t,r){var n=r[0],o=r[1];e._insert(t,n,o)}function refRemove(e,t,r){var n=r[0],o=r[1].length;e._remove(t,n,o)}function refMove(e,t,r){var n=r[0],o=r[1],s=r[2];e._move(t,n,o,s)}function refStringInsert(e,t,r){var n=r[0],o=r[1];e._stringInsert(t,n,o)}function refStringRemove(e,t,r){var n=r[0],o=r[1];e._stringRemove(t,n,o)}function addListener(e,t,r){function n(n,o){for(var s,i=o[o.length-1],a=e._refs.toMap,f=0,p=n.length;p>f;f++){s=s?s+"."+n[f]:n[f];var d=a[s];if(d)for(var h=n.slice(f+1),v=0,m=d.length;m>v;v++){var u=d[v],l=u.fromSegments.concat(h);if(e._get(l)===e._get(n))e.emit(t,l,o);else{var c=u.model.pass(i,!0);c._dereference=noopDereference,r(c,l,o,n)}}}var g=e._refs.parentToMap,d=g[s];if(d)for(var v=0,m=d.length;m>v;v++){var u=d[v],_=e._get(u.toSegments),M=e._get(u.fromSegments);if(M!==_){var c=u.model.pass(i,!0);c._dereference=noopDereference,c._set(u.fromSegments,_)}}}e.on(t,n)}function noopDereference(e){return e}function Ref(e,t,r,n){this.model=e&&e.pass({$ref:this}),this.from=t,this.to=r,this.fromSegments=t.split("."),this.toSegments=r.split("."),this.parentTos=[];for(var o=1,s=this.toSegments.length;s>o;o++){var i=this.toSegments.slice(0,o).join(".");this.parentTos.push(i)}this.updateIndices=n&&n.updateIndices}function FromMap(){}function ToMap(){}function Refs(e){this.model=e,this.fromMap=new FromMap,this.toMap=new ToMap,this.parentToMap=new ToMap}function listMapAdd(e,t,r){e[t]||(e[t]=[]),e[t].push(r)}function listMapRemove(e,t,r){var n=e[t];if(n){var o=n.indexOf(r);-1!==o&&(n.splice(o,1),n.length||delete e[t])}}var util=require("../util"),Model=require("./Model");Model.INITS.push(function(e){var t=e.root;t._refs=new Refs(t),addIndexListeners(t),addListener(t,"change",refChange),addListener(t,"load",refLoad),addListener(t,"unload",refUnload),addListener(t,"insert",refInsert),addListener(t,"remove",refRemove),addListener(t,"move",refMove),addListener(t,"stringInsert",refStringInsert),addListener(t,"stringRemove",refStringRemove)}),Model.prototype._canRefTo=function(e){return this.isPath(e)||e&&"function"==typeof e.ref},Model.prototype.ref=function(){var e,t,r;1===arguments.length?t=arguments[0]:2===arguments.length?this._canRefTo(arguments[1])?(e=arguments[0],t=arguments[1]):(t=arguments[0],r=arguments[1]):(e=arguments[0],t=arguments[1],r=arguments[2]);var n=this.path(e),o=this.path(t);if(!o)return t.ref(n);var s=n.split(".");if(s.length<2)throw new Error("ref must be performed under a collection and document id. Invalid path: "+n);this.root._refs.remove(n);var i=this.get(t);return this._set(s,i),this.root._refs.add(n,o,r),this.scope(n)},Model.prototype.removeRef=function(e){var t=this._splitPath(e),r=t.join(".");this._removeRef(t,r)},Model.prototype._removeRef=function(e,t){this.root._refs.remove(t),this.root._refLists.remove(t),this._del(e)},Model.prototype.removeAllRefs=function(e){var t=this._splitPath(e);this._removeAllRefs(t)},Model.prototype._removeAllRefs=function(e){this._removeMapRefs(e,this.root._refs.fromMap),this._removeMapRefs(e,this.root._refLists.fromMap)},Model.prototype._removeMapRefs=function(e,t){for(var r in t){var n=t[r].fromSegments;util.contains(e,n)&&this._removeRef(n,r)}},Model.prototype.dereference=function(e){var t=this._splitPath(e);return this._dereference(t).join(".")},Model.prototype._dereference=function(e,t,r){if(0===e.length)return e;var n,o=this.root._refs.fromMap,s=this.root._refLists.fromMap;do{var i="";n=!1;for(var a=0,f=e.length;f>a;a++){i=i?i+"."+e[a]:e[a];var p=o[i];if(p){var d=e.slice(a+1);e=p.toSegments.concat(d),n=!0;break}var h=s[i];if(h&&h!==r){var v=f>a+2,m=f>a+1;if(!(v||t&&m))continue;e=h.dereference(e,a),n=!0;break}}}while(n);return 0===e.length?["$null"]:e},Refs.prototype.add=function(e,t,r){var n=new Ref(this.model,e,t,r);return this._add(n)},Refs.prototype._add=function(e){this.fromMap[e.from]=e,listMapAdd(this.toMap,e.to,e);for(var t=0,r=e.parentTos.length;r>t;t++)listMapAdd(this.parentToMap,e.parentTos[t],e);return e},Refs.prototype.remove=function(e){var t=this.fromMap[e];if(t){delete this.fromMap[e],listMapRemove(this.toMap,t.to,t);for(var r=0,n=t.parentTos.length;n>r;r++)listMapRemove(this.parentToMap,t.parentTos[r],t);return t}},Refs.prototype.toJSON=function(){var e=[];for(var t in this.fromMap){var r=this.fromMap[t];e.push([r.from,r.to])}return e};
},{"../util":52,"./Model":40}],50:[function(require,module,exports){
function addListener(e,t){function r(r,n){var i=n[n.length-1],s=e._refLists.fromMap;for(var o in s){var a=s[o];i.$refList!==a&&a.onMutation(t,r,n)}}e.on(t,r)}function patchFromEvent(e,t,r,n){var i=n.fromSegments.length,s=t.length,o=r[r.length-1],a=n.model.pass(o,!0);if(s===i){if("insert"===e){var f=r[0],m=r[1],v=setNewToValues(a,n,m);return void a._insert(n.idsSegments,f,v)}if("remove"===e){var f=r[0],d=r[1].length,v=a._remove(n.idsSegments,f,d);if(n.deleteRemoved)for(var g=0;g<v.length;g++){var u=n.itemById(v[g]);a._del(n.toSegmentsByItem(u))}return}if("move"===e){var h=r[0],l=r[1],d=r[2];return void a._move(n.idsSegments,h,l,d)}var m="change"===e?r[0]:a._get(n.fromSegments);if(!m)return void a._set(n.idsSegments,[]);var v=setNewToValues(a,n,m);return void a._set(n.idsSegments,v)}if(i>s)return void a._setArrayDiff(n.fromSegments,n.get());var f=t[i],c=a._get(n.fromSegments.concat(f)),p=n.toSegmentsByItem(c);if(s>i+1)throw new Error("Mutation on descendant of refList `from` should have been dereferenced: "+t.join("."));if("change"===e)return a._set(p,c),void updateIdForValue(a,n,f,c);if("stringInsert"===e){var y=r[0],S=r[1];return a._stringInsert(p,y,S),void updateIdForValue(a,n,f,c)}if("stringRemove"===e){var y=r[0],d=r[1];return a._stringRemove(p,y,d),void updateIdForValue(a,n,f,c)}if("insert"===e||"remove"===e||"move"===e)throw new Error("Array mutation on child of refList `from`should have been dereferenced: "+t.join("."))}function setNewToValues(e,t,r){for(var n=[],i=0;i<r.length;i++){var s=r[i],o=t.idByItem(s);void 0===o&&"object"==typeof s&&(o=s.id=e.id());var a=t.toSegmentsByItem(s);if(void 0===o||void 0===a)throw new Error("Unable to add item to refList: "+s);e._get(a)!==s&&e._set(a,s),n.push(o)}return n}function updateIdForValue(e,t,r,n){var i=t.idByItem(n),s=t.idsSegments.concat(r);e._set(s,i)}function patchToEvent(e,t,r,n){var i=n.toSegments.length,s=t.length,o=r[r.length-1],a=n.model.pass(o,!0);if(s===i){if("insert"===e){for(var f=(r[0],r[1]),m=0;m<f.length;m++){var v=f[m],d=n.indicesByItem(v);if(d)for(var g=0;g<d.length;g++){var u=n.fromSegments.concat(d[g]);a._set(u,v)}}return}if("remove"===e){for(var h=r[0],f=r[1],l=f.length,m=h,c=h+l;c>m;m++){var d=n.indicesByItem(f[m]);if(d)for(var g=0,p=d.length;p>g;g++){var u=n.fromSegments.concat(d[g]);a._set(u,void 0)}}return}if("move"===e)return}if(i>=s)return void a._setArrayDiff(n.fromSegments,n.get());if(s>i+1){var v=a._get(t.slice(0,i+1)),d=n.indicesByItem(v);if(!d)return;for(var y=t.slice(i+1),m=0;m<d.length;m++){var S=d[m],_=n.fromSegments.concat(S,y);_=a._dereference(_,null,n),r=r.slice(),r[r.length-1]=a._pass,a.emit(e,_,r)}}else if("change"!==e&&"load"!==e&&"unload"!==e){var v=a._get(t.slice(0,i+1)),d=n.indicesByItem(v);if(d)if("stringInsert"!==e)if("stringRemove"!==e){if("insert"===e||"remove"===e||"move"===e)for(var m=0;m<d.length;m++){var _=n.fromSegments.concat(d[m]);_=a._dereference(_,null,n),r=r.slice(),r[r.length-1]=a._pass,a.emit(e,_,r)}}else for(var I=r[0],l=r[1],m=0;m<d.length;m++){var u=n.fromSegments(d[m]);a._stringRemove(u,I,l)}else for(var I=r[0],v=r[1],m=0;m<d.length;m++){var u=n.fromSegments(d[m]);a._stringInsert(u,I,v)}}else{var v,L;"change"===e?(v=r[0],L=r[1]):"load"===e?(v=r[0],L=void 0):"unload"===e&&(v=void 0,L=r[0]);var B=n.indicesByItem(v),R=n.indicesByItem(L);if(!B&&!R)return;if(R&&!equivalentArrays(R,B))for(var m=0;m<R.length;m++){var u=n.fromSegments.concat(R[m]);a._set(u,void 0)}if(B)for(var m=0;m<B.length;m++){var u=n.fromSegments.concat(B[m]);a._set(u,v)}}}function equivalentArrays(e,t){if(!e||!t)return!1;if(e.length!==t.length)return!1;for(var r=0;r<e.length;r++)if(e[r]!==t[r])return!1;return!0}function patchIdsEvent(e,t,r,n){var i=n.idsSegments.length,s=t.length,o=r[r.length-1],a=n.model.pass(o,!0);if(s===i){if("insert"===e){for(var f=r[0],m=r[1],v=[],d=0;d<m.length;d++){var g=n.itemById(m[d]);v.push(g)}return void a._insert(n.fromSegments,f,v)}if("remove"===e){var f=r[0],u=r[1].length;return void a._remove(n.fromSegments,f,u)}if("move"===e){var h=r[0],l=r[1],u=r[2];return void a._move(n.fromSegments,h,l,u)}}if(i>=s)return void a._setArrayDiff(n.fromSegments,n.get());var f=t[i],c=n.idByIndex(f),p=n.itemById(c),y=n.fromSegments.concat(f);a._get(y)!==p&&a._set(y,p)}function RefList(e,t,r,n,i){this.model=e&&e.pass({$refList:this}),this.from=t,this.to=r,this.ids=n,this.fromSegments=t&&t.split("."),this.toSegments=r&&r.split("."),this.idsSegments=n&&n.split("."),this.options=i,this.deleteRemoved=i&&i.deleteRemoved}function FromMap(){}function RefLists(e){this.model=e,this.fromMap=new FromMap}var util=require("../util"),Model=require("./Model");Model.INITS.push(function(e){var t=e.root;t._refLists=new RefLists(t);for(var r in Model.MUTATOR_EVENTS)addListener(t,r)}),Model.prototype.refList=function(){var e,t,r,n;2===arguments.length?(t=arguments[0],r=arguments[1]):3===arguments.length?this.isPath(arguments[2])?(e=arguments[0],t=arguments[1],r=arguments[2]):(t=arguments[0],r=arguments[1],n=arguments[2]):(e=arguments[0],t=arguments[1],r=arguments[2],n=arguments[3]);var i,s=this.path(e);if(Array.isArray(t)){i=[];for(var o=0;o<t.length;o++)i.push(this.path(t[o]))}else i=this.path(t);var a=this.path(r),f=this.root._refLists.add(s,i,a,n);return this.pass({$refList:f})._setArrayDiff(f.fromSegments,f.get()),this.scope(s)},RefList.prototype.get=function(){var e=this.model._get(this.idsSegments);if(!e)return[];for(var t=this.model._get(this.toSegments),r=[],n=0;n<e.length;n++){var i=e[n];r.push(t&&t[i])}return r},RefList.prototype.dereference=function(e,t){var r=e.slice(t+1),n=this.idByIndex(r[0]);return null==n?[]:(r[0]=n,this.toSegments.concat(r))},RefList.prototype.toSegmentsByItem=function(e){var t=this.idByItem(e);if(void 0!==t)return this.toSegments.concat(t)},RefList.prototype.idByItem=function(e){if(e&&e.id)return e.id;var t=this.model._get(this.toSegments);for(var r in t)if(e===t[r])return r},RefList.prototype.indicesByItem=function(e){var t=this.idByItem(e),r=this.model._get(this.idsSegments);if(r){for(var n,i=-1;;){if(i=r.indexOf(t,i+1),-1===i)break;n?n.push(i):n=[i]}return n}},RefList.prototype.itemById=function(e){return this.model._get(this.toSegments.concat(e))},RefList.prototype.idByIndex=function(e){return this.model._get(this.idsSegments.concat(e))},RefList.prototype.onMutation=function(e,t,r){util.mayImpact(this.toSegments,t)?patchToEvent(e,t,r,this):util.mayImpact(this.idsSegments,t)?patchIdsEvent(e,t,r,this):util.mayImpact(this.fromSegments,t)&&patchFromEvent(e,t,r,this)},RefLists.prototype.add=function(e,t,r,n){var i=new RefList(this.model,e,t,r,n);return this.fromMap[e]=i,i},RefLists.prototype.remove=function(e){var t=this.fromMap[e];return delete this.fromMap[e],t},RefLists.prototype.toJSON=function(){var e=[];for(var t in this.fromMap){var r=this.fromMap[t];e.push([r.from,r.to,r.ids,r.options])}return e};
...
(function (global){
var DerbyStandalone=require("derby/lib/DerbyStandalone");global.derby=module.exports=new DerbyStandalone,module.exports.App.prototype.registerViews=function(e){e(this.views)},require("derby/node_modules/derby-parsing");
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
//# sourceMappingURL=derby-standalone.slim.min.map.json